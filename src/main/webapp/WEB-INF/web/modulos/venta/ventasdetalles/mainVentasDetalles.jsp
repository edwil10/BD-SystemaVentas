<%-- 
    Document   : mainVentasDetalles
    Created on : 05-dic-2018, 7:39:33
    Author     : edwil
--%>
    ...
    <br/>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <a class="btn btn-info" href="${pageContext.request.contextPath}/formVentasDetalles">Nuevo</a>  
                </div>
            </div>
              </form>
          </div>
    ...
    <c:if test="${!empty ListaVentas}">
        <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Reporte de Ventas Detalles</h3>                                    
                </div><!-- /.box-header -->        
          ...
          <tbody>
                <c:forEach items="${ListaManufactura}" var="dato">
                      <tr>
                        ...
                        <td align="center">
                            <a href="${pageContext.request.contextPath}/elimVentD?id=${dato.idMovVnt}" ><span title="Eliminar" class="glyphicon glyphicon-remove"></span></a>
                            <a href="${pageContext.request.contextPath}/formModif2VentasDetalles?id=${dato.idMovVnt}" ><span title="Editar" class="glyphicon glyphicon-edit"></span></a>
